...
def response_generator():
    response = ai_ask("Pretend you are an educated black woman.  Please provide a response given the provided context.  Please provide the response only with no before or after commentary.",
...
st.title("Your AI chatbot friend")
